	...
	if (database.db) {
		authUser(database, paramId, paramPassword, function(err, docs) {
			...
			if(docs){
				...
				res.write("<br><br><a href='fuck/login.html'>다시 로그인하기</a>");
				res.end();
			}
		});
		...
		addUser(database, paramId, paramPassword, paramName, function(err, addedUser) {
			...
			if (addedUser) {
				console.dir(addedUser);
					...
					res.write("<br><br><a href='/fuck/public/html/login.html'>다시 로그인하기 </a>");
				
					res.end("<img src='/fuck/public/images/다운로드2.jpg' width = '40%'>");
